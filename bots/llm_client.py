...
def trade_review_prompt(
    ...
    """
    Generate standardized trade review prompt for the Economics engine.
...
def congressional_brief_prompt(
    ...
    """
    Generate congressional trade analysis prompt for Congressional tracker.
...
def options_setup_prompt(
    ...
    """
    Generate 0DTE setup analysis prompt for the Options desk.
